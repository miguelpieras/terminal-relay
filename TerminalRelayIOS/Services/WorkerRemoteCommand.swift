...
enum WorkerRemoteCommand {
    ...
    static let runtimeInfo = "\(WorkerSessionProtocol.helperPath) runtime-info"
    static let runtimeUpdateStatus = "\(WorkerSessionProtocol.helperPath) runtime-update-status"
    static let runtimeUpdateRequest = "\(WorkerSessionProtocol.helperPath) runtime-update-request"
